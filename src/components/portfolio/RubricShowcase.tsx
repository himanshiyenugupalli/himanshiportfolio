/**
 * RubricShowcase — Sample RLHF Rubric / Response Critique Card
 */
  ...
  return (
    <div className="reveal my-12 p-6 rounded-xl border border-amber-500/20 bg-zinc-900/60 backdrop-blur-md">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {/* Response A (Winner) */}
        <div className="p-4 rounded-lg bg-zinc-950 border-2 border-amber-500/50 relative flex flex-col justify-between">
          <div>
        ...
        {/* Response B (Rejected) */}
        <div className="p-4 rounded-lg bg-zinc-950 border border-zinc-800 opacity-75 flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between mb-2">
